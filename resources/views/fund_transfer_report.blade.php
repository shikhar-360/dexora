                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs member-tab" role="tablist">
                            <li role="presentation" class="active"><a href="#all_members" aria-controls="all_members"
                                    role="tab" data-toggle="tab">Fund Transfer Report.</a></li>
                        </ul>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="all_members">
                                @if(isset($data['data']))
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card">
                                                <h5 class="card-title mb-4">Fund Transfer Report </h5>
                                                    ...
                                                    <table class="table no-wrap user-table mb-0">
                                                        <thead class="table-light">
                                                            <tr>
                                                                ...
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">For Member Name</th>
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">For Member Code</th>
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">For MT5 Id</th>
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">Used Date</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @foreach($data['data'] as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td><span>{{$value['status'] == 1 ? "Used" : "Unused"}}</span></td>
                                                                    <td><span>{{$value['for_user_name']}}</span></td>
                                                                    <td><span class="badge badge-inverse fs-4">{{$value['for_user_refferal_code']}}</span></td>
                                                                    <td><span class="badge badge-inverse fs-4">{{$value['for_user_mt5']}}</span></td>
                                                                    <td><span class="badge badge-inverse fs-4">{{$value['for_created_on']}}</span></td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>
