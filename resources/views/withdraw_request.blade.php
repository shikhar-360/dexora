    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Withdraw BankWire Request</h4>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs member-tab" role="tablist">
                            <li role="presentation" class="active"><a href="#all_members" aria-controls="all_members"
                                    role="tab" data-toggle="tab">Withdraw BankWire Request</a></li>
                        </ul>
                                                        ...
                                                        <thead class="table-light">
                                                            <tr>
                                                               <!--  <th scope="col" class="border-0 fs-4 font-weight-medium ps-4">
                                                                ...
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">Account Holder Name</th>
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">Account Number</th>
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">Bank Name</th>
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">IFSC Code</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach($data['data'] as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td><span>{{$value['account_holder_name']}}</span></td>
                                                                    <td><span>{{$value['account_number']}}</span></td>
                                                                    <td><span>{{$value['bank_name']}}</span></td>
                                                                    <td><span>{{$value['ifsc_code']}}</span></td>
                                                                    <td>
                                                                        <form action="{{route('withdrawBankProcess')}}" method="POST">
