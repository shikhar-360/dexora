    ...
    <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Deduct/Withdraw User Balance</h4>
                </div>
            </div>
        <div class="row">
            <div class="white-box">
                <div class="panel-body">
                    ...
                    <form action="{{ route('searchUserForWithdraw') }}" enctype="multipart/form-data" method="post">
                        {{ method_field("POST") }}
                            ...
                            <table class="table no-wrap">
                              ...
                              <tbody>
                                    @if(isset($data['user']))
                                        ...
                                        <form method="post" action="{{route('deductUserWithdraw')}}">
                                            <tr class="advanced-table active">
                                                ...
                                                <td>
                                                    <select class="form-select category-select" name="wallet" id="exampleFormControlSelect1" required>
                                                        <option value="ALL">All</option>
                                                        <option value="PS">Profit Sharing</option>
                                                    </select>
                                                </td>
                                                <td>
