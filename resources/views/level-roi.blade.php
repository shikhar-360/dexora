    ...
    <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Level ROI</h4>
                </div>
            </div>
        <div class="row">
            <div class="white-box">
                <div class="panel-body">
                    ...
                    @endphp
                    <form action="{{ route('level-roi.update', $editData['id']) }}" enctype="multipart/form-data" method="post">
                    	{{ method_field("PUT") }}
                    @else
                    <form action="{{ route('level-roi.store') }}" enctype="multipart/form-data" method="post">
                    	{{ method_field("POST") }}
                        ...
                        <table id="example" class="table table-striped">
                                    ...
                                    @if(isset($data['data']))
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('level-roi.edit',$pvalue['id'])}}"><button style="float:left;" type="button" class="btn btn-info btn-outline btn-circle btn m-r-5"><i class="ti-pencil-alt"></i></button></a>
<!--                                             <form action="{{ route('level-roi.destroy', $pvalue['id'])}}" method="post">
                                            @csrf
                                            @method('DELETE')
