                ...
                <div class="p-4 rounded-xl w-full mx-auto border border-[#2b2b2f] bg-black relative boxbgsvg1">
                    ...
                    <form class="relative" method="post" action="{{route('process.package')}}">
                        ...
                        <div class="relative mb-8 flex items-center justify-between border border-white border-opacity-30 p-3 rounded gap-3 bg-black bg-opacity-50">
                            ...
                            <input type="text" name="amount" id="amount" value="{{$data['user']['topup_balance']}}" placeholder="0.0" required="required" class="border-l pl-4 border-white border-opacity-15 outline-none shadow-none bg-transparent w-full block text-base" readonly>
